        ...
        <div className="relative container pb-0 pt-14 sm:pt-20 lg:py-44">
          ...
          >
            <div className="space-y-5 sm:space-y-6">
              ...
              <h2 className="nc-SectionHero2Item__heading pb-20 uppercase font-sans   font-bold text-xl sm:text-2xl md:text-3xl xl:text-4xl 2xl:text-5xl !leading-[114%] text-slate-900">
                {item.heading}
              </h2>
            </div>
